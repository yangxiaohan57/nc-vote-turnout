...
author: "Caleb(Coordinator), Junbo(Presenter), Nikhil(Checker), Rhayoung(Coder), Xiaohan(Writer)"
date: "10/18/20"
output: 
    pdf_document:
...
bio <- read.csv('bioassay.csv',sep = ' ', header = T)
...
history <- read.csv('history_stats_20161108.csv',sep = '\t', header = T)
voter <- read.csv('voter_stats_20161108.csv',sep = ' ', header = T)
...
```{r,include=TRUE,fig.width=3, fig.height=3.5, echo=FALSE}
plot1<- ggplot(bio, aes(x=weight, y=log(uterus))) + geom_point()
```
...
```{r,include=TRUE,fig.width=8, fig.height=3.5, echo=FALSE}
plot2 <- ggplot(bio,
...
![Summary](/Users/롸/Desktop/oneone.png){width=50%}
...
```{r,include=TRUE,fig.width=8, fig.height=3.5, echo=FALSE}
plot6 <- dotplot.ranef.mer(ranef(final_model_q1,condVar=TRUE))$lab
plot7 <- dotplot.ranef.mer(ranef(final_model_q1,condVar=TRUE))$protocol
figure3 <- ggarrange(plot6,plot7,
          ncol = 2, nrow = 1)
figure3
```
...
```{r,include=TRUE,fig.width=8, fig.height=3.5, echo=FALSE}
plot3 <- ggplot(agg_subdata, aes(x=Party, y=turnout, fill=Party)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Party vs Turnout by Race", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Race)
```
...
```{r,include=TRUE,fig.width=8, fig.height=3.5, echo=FALSE}
plot4 <- ggplot(agg_subdata, aes(x=Party, y=turnout, fill=Party)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Sex)

figure2 <- ggarrange(plot3,plot4,
          ncol = 2, nrow = 1)
figure2
```
We also drew a plot to check if turnout rate varied by county. As shown in the plot, counties such as Ashe, Hyde and Chatham showed high turnout rates whereas Hoke and Pasquotank showed relatively low turnout rates. 
...
![Vote](/Users/롸/Desktop/votefinal.png){width=80%}
...
```{r,include=TRUE,fig.width=8, fig.height=4, echo=FALSE}
...
1.1 Histogram for the response variable
...
1.2 Variable EE versus Log uterus

```{r}
ggplot(bio, aes(x=EE, y=log(uterus))) + geom_point()
```
...
```{r}
ggplot(bio, aes(x=EE, y=log(uterus))) + geom_point() + facet_wrap(~protocol)
ggplot(bio, aes(x=EE, y=log(uterus))) + geom_point() + facet_wrap(~lab)
ggplot(bio, aes(x=EE, y=log(uterus))) + geom_point() + facet_wrap(~group)
```

1.4 EDA for ZM

```{r}
#facet-wrap by protocol, lab, group
...
```{r}
ggplot(bio, aes(x=ZM, y=log(uterus))) + geom_point() + facet_wrap(~group)+ geom_smooth(method="lm",col="red3")
```

1.5 Binned weight and Log uterus

```{r}
ggplot(bio, aes(x=weight_bin, y=log(uterus), fill=weight_bin)) + geom_boxplot() + coord_flip() + scale_fill_brewer(palette="Reds") +  labs(title="Binned Weight vs Log Uterus",
       x="Binned Weight",y="Log Uterus") +
...
2.1 Histogram for the response variable

```{r}
hist(agg_subdata$turnout)
```

2.2 EDA for Age

```{r}
ggplot(agg_subdata, aes(x=Age, y=turnout, fill=Age)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none")
```

```{r}
ggplot(agg_subdata, aes(x=Age, y=turnout, fill=Age)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~County)
```

```{r}
ggplot(agg_subdata, aes(x=Age, y=turnout, fill=Age)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Sex)
```

```{r}
ggplot(agg_subdata, aes(x=Age, y=turnout, fill=Age)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Race)
```

```{r}
ggplot(agg_subdata, aes(x=Age, y=turnout, fill=Age)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Party)
```
...
```{r}
ggplot(agg_subdata, aes(x=Sex, y=turnout, fill=Sex)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none")
```

```{r}
ggplot(agg_subdata, aes(x=Sex, y=turnout, fill=Sex)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Party)
```

```{r}
ggplot(agg_subdata, aes(x=Sex, y=turnout, fill=Sex)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout by Age", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Age)
```

```{r}
ggplot(agg_subdata, aes(x=Sex, y=turnout, fill=Sex)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~County)
```

```{r}
ggplot(agg_subdata, aes(x=Sex, y=turnout, fill=Sex)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout by Race", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Race)
```
...
```{r}
ggplot(agg_subdata, aes(x=Party, y=turnout, fill=Party)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none")
```


```{r}
ggplot(agg_subdata, aes(x=Party, y=turnout, fill=Party)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~County)
```
...
```{r}
ggplot(agg_subdata, aes(x=Party, y=turnout, fill=Party)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Sex vs Turnout", x="Sex",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Age)
```
...
```{r}
ggplot(agg_subdata, aes(x=Race, y=turnout, fill=Race)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Race vs Turnout", x="Race",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~County)
```


```{r}
ggplot(agg_subdata, aes(x=Race, y=turnout, fill=Race)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Race vs Turnout", x="Race",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Age)
```

```{r}
ggplot(agg_subdata, aes(x=Race, y=turnout, fill=Race)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Race vs Turnout", x="Race",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Race)
```

```{r}
ggplot(agg_subdata, aes(x=Race, y=turnout, fill=Race)) + geom_boxplot() + scale_fill_brewer(palette="Reds") +  labs(title="Race vs Turnout", x="Race",y="turnout") + theme_classic() + theme(legend.position="none") + facet_wrap(~Sex)
```
